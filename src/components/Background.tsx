...
const Background = () => {
  return (
    <div className="flex w-[40%] justify-center items-center absolute">
      ...
      <div className="rounded-[50%] bg-[#6556CD] h-[150px] w-[150px] z-50 border-8 border-white flex items-center justify-center top-[15rem] text-4xl font-bold right-[75px] rotate-45 absolute">
        {"</>"}
      </div>
    </div>
  );
